...
# Obtener el c�digo html de la p�gina web
pagina_web <- read_html(url)

# Asignar la clase
css_producto <- "a.a-link-normal.s-access-detail-page.s-color-twister-title-link.a-text-normal"

# Obtener el c�digo html que contiene el nombre del producto
...
# Obtener el contenido de la clase en c�digo html
precio_html <- html_nodes(pagina_web,css_precio)

# Limpiar el c�digo para obtener el texto
...
#Tomemos el html y busquemos la categor�a t�tulos (ver filmina)
#imdb es una funci�n, le estoy pasando argumentos a traves del operador %>%
# le paso el nodo donde esta la info que quiero y le pido el texto de ah�
...
#ahora quiero el a�o, como viene en texto lo quiero reformatear as.Date
...
#Ahora quiero la duraci�n, reformateo a n�mero 
...
#otro atributo, recaudaci�n, pero reformateado
